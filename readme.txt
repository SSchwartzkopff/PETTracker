...
The simulation data will be prepared with the help of DataPreperation.ipynb.

Included are:
	DataPreperation.ipynb - (Jupyter Notebook file) turns simulation files ".sim" from MEGAlib into ".csv" files usable by the neural network
